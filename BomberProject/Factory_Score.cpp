...
,m_pRate1Tex( pRate1Tex )
{
	...
	m_pRate_10	= new SpriteObject( pD3DDevice, m_pRate10Tex, vRateSize, g_vZero, 
									D3DXVECTOR3( wide+340.0f, height-140.0f+15.0f, 0.0f ), Rect( 0, 0, 128, 64 ),g_vZero, g_vZero );
	//	×1
	m_pRate_1	= new SpriteObject( pD3DDevice, m_pRate1Tex, vRateSize, g_vZero, 
									D3DXVECTOR3( wide+340.0f, height-70.0f+15.0f, 0.0f ), Rect( 0, 0, 128, 64 ),g_vZero, g_vZero );
	//	×30
	m_pRate_30	= new SpriteObject( pD3DDevice, m_pRate30Tex, vRateSize, g_vZero, 
									D3DXVECTOR3( wide+340.0f, height+20.0f, 0.0f ), Rect( 0, 0, 128, 64 ),g_vZero, g_vZero );
