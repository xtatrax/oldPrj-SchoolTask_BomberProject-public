...
void				BassPacket::SearchSoundAndStop(	const    char* SoundName	)	{	if( m_pStage && m_pStage->m_pSound )	m_pStage->m_pSound->SearchSoundAndStop( SoundName )	; }
void				BassPacket::SearchWaveAndPlay(	const    char* WaveName		)	{	if( m_pStage && m_pStage->m_pSound )	m_pStage->m_pSound->SearchWaveAndPlay( WaveName  )	; }
void				BassPacket::SearchWaveAndStop(	const    char* WaveName		)	{	if( m_pStage && m_pStage->m_pSound )	m_pStage->m_pSound->SearchWaveAndStop( WaveName  )	; }
...
void				FactoryPacket::SearchSoundAndStop(	const char*  SoundName )	{	if( m_pStage && m_pStage->m_pSound )	m_pStage->m_pSound->SearchSoundAndStop( SoundName )	; }
void				FactoryPacket::SearchWaveAndPlay(	const char*  WaveName  )	{	if( m_pStage && m_pStage->m_pSound )	m_pStage->m_pSound->SearchWaveAndPlay( WaveName  )	; }
void				FactoryPacket::SearchWaveAndStop(	const char*  WaveName  )	{	if( m_pStage && m_pStage->m_pSound )	m_pStage->m_pSound->SearchWaveAndStop( WaveName  )	; }
