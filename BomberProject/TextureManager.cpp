...
void TextureManager::Release(){
	...
	//SafeReleasePointerContainer( m_vecTextures );
	m_vecTextures.clear();
};
/////////////////// ////////////////////
//// 用途       ：LPTATRATEXTURE TextureManager::addTexture(LPDIRECT3DDEVICE9 pD3DDevice,
...
/////////////////// ////////////////////
//// 用途       ：LPTATRATEXTURE TextureManager::addTextureEx(LPDIRECT3DDEVICE9 pD3DDevice,const wchar_t* filepath,
////            ：  	UINT Width, UINT Height, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter,
////            ：  	DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO *pSrcInfo, PALETTEENTRY *pPalette, const wchar_t* texturename )
//// カテゴリ   ：関数
//// 用途       ：テクスチャーの読み込み
...
/////////////////// ////////////////////
//// 用途       ：LPTATRATEXTURE TextureManager::addTextureExLight(LPDIRECT3DDEVICE9 pD3DDevice,const wchar_t* filepath,
...
/////////////////// ////////////////////
//// 用途       ：LPTATRATEXTURE TextureManager::TextureSearchFromName(const wchar_t* filename)
//// カテゴリ   ：関数
