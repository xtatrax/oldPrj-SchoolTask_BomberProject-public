...
public:
	...
	////            ：
	////
	LPDIRECT3DTEXTURE9 addTextureEx(
		LPDIRECT3DDEVICE9	pD3DDevice			,
		const wchar_t*		filepath			,
		UINT				Width				,
		UINT				Height				,
	...
	////            ：
	////
	LPDIRECT3DTEXTURE9 addTextureExLight(
		LPDIRECT3DDEVICE9	pD3DDevice	,
		const wchar_t*		filepath	,
		DWORD				Usage		,
		D3DFORMAT			Format		,
...
public:
	...
	/////////////////// ////////////////////
	//// 用途       ：const LPDIRECT3DTEXTURE9 TextureManager::Texture::getTexture()
	//// カテゴリ   ：ゲッター
